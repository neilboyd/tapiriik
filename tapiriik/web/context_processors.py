...
from tapiriik.settings import SITE_VER, PP_WEBSCR, PP_BUTTON_ID, PP_RECEIVER_ID, SOFT_LAUNCH_SERVICES, DISABLED_SERVICES, WITHDRAWN_SERVICES, CELEBRATION_MODES
