...
from tapiriik.settings import SITE_VER, WEB_ROOT, PP_WEBSCR, PP_RECEIVER_ID, SOFT_LAUNCH_SERVICES, DISABLED_SERVICES, WITHDRAWN_SERVICES, CELEBRATION_MODES
